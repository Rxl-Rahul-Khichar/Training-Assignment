            ...
            <div class="card-body" >
                ...
                <table>
                    ...
                    <tr> <td colspan="3">
                        ...
                        <span class="txt"> Rating:${rating}</span>
                        <span class="txt"> Rated by:${post.resourceRated.size()}</span>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td >
                            <button type="button" class="btn-sm btn-info btn-warning" data-toggle="modal" title="Edit Document" data-target="#uploadDocument">
                                <i class="fas fa-file">
                                </i>
                            </button>
                            ...
                            <button type="button" class="btn-sm btn-info btn-warning" data-toggle="modal" title="invite" data-target="#topicinvite">
        ...
        <div class="cardlogin">
            ...
            <div class="card-body">
                <g:each in="${trending}" var="it">
                    <table  style="width:100%">
                        ...
                        <g:else>
                            ...
                            <tr>
                                <td width="100px"><g:form  action="addTopics" class="topicForm">
                                    <select class="form-control" name="selection">
                ...
                %{--<table  style="width:100%">
                    ...
                    <tr>
                        <td ><g:form controller="topic" action="addTopic" class="topicForm">
                            <select class="form-control" name="selection">
                                <option>CASUAL</option>
                                <option>SERIOUS</option>
                                <option>VERY SERIOUS</option>
