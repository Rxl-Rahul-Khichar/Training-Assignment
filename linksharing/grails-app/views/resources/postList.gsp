        ...
        <div class="card-body">
            <table id="selectedColumn" class="table  table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <g:each var="post" in="${postList}">
                    <tr>
                        <td class="txt">${post.id}</td>
                        <td  class="txt">${post.description}</td>
                        <td  class="txt">${post.createdBy.userName}</td>
                        <td  class="txt">${post.topic.topicName}</td>
                        <g:if test="${post.hasProperty("filepath")}">
                            <td  class="txt"> File</td>
                        </g:if>
                        <g:else>
                            <td class="txt"> Link</td>
                        </g:else>
                        <td>
