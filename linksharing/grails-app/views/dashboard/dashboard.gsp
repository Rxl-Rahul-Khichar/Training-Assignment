            ...
            $( "#save" ).click(function (){
                $.ajax( {
                    ...
                    success: function(response) {
                        ...
                        document.getElementById("test").innerHTML=response[0]
                    },
                    error: function (response){
                        document.getElementById("test").innerHTML= "topic already exist"
                        $('#topicModal').modal('hide');
                    }
                } );
            });
...
<p class="tt" id="tl">${flash.message2}</p>
    ...
    <div class="d-flex justify-content-center h-100">
        ...
        <div class="cardtop">
            <div class="card-header">
                ...
                <div style="float:right"><g:link controller="dashboard" action="viewUserProfile" params="[id:session.user.id]">View All </g:link></div><br>
            ...
            <div class="card-body">
                ...
                <table  style="width:100%">
                    <tr>
                        ...
                        <g:if test="${it.topic.createdBy.userName.equals(session.user.userName) || (session.user.admin)}">
                            <td colspan="10">
                                <div class= "topName">
                                    <g:link  controller="topic" action="viewTopic" params="[id:it.topic.id]">Topic: "${it.topic.topicName}"</g:link>
                                </div>
                                <div class="editSubTopicName" style="display: none">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="submit" id="buttonChange"  class="btn btn-info btn-warning" title="Edit Topic Name" >
                                <i class="fas fa-edit">
                                </i>
                            </button>
                            </div>
                        ...
                        <td>
                            <g:form controller="topic" action="deleteTopic" params="[id:it.topic.id]">
